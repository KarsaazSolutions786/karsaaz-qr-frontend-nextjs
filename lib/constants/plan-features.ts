 ...
 *
 * Includes base features + shape options + sticker/advanced shape options.
 */
...
/** Core plan features (non-shape) */
const BASE_FEATURES: PlanFeatureOption[] = [
