          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h2 className="text-2xl font-bold text-gray-900">
                ...
                1 <span className="text-sm text-gray-400 font-normal">/ {selectedOrg.max_capacity ?? 10}</span>
              </h2>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            ...
            <div>
              <h3 className="font-medium text-gray-900 group-hover:text-primary-600">Invite Members</h3>
