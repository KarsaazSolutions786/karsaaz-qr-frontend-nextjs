/**
 * Purpose: Executes PrivacyPolicy functionality.
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8 md:p-12">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          <section>
            ...
            <p>
              KarsaazQR (&ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) is committed to
              protecting your privacy. This Privacy Policy explains how we collect, use, disclose,
              and safeguard your information when you use our QR code generation and management
              service.
            </p>
            <p className="mt-4">
              We are registered with the Information Commissioner&apos;s Office (ICO) under
              registration number ZB891350 and comply with the UK General Data Protection Regulation
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>Register for an account or sign up for our service</li>
              <li>Use our QR code generation and management services</li>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li>Company name, business information, and website</li>
              <li>
                Payment and billing information (processed securely through third-party payment
                processors)
              </li>
              <li>QR code content, design preferences, and customization data</li>
              <li>Analytics data including scan statistics and geographic information</li>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>IP address, device information, and unique device identifiers</li>
              <li>Browser type, version, and operating system</li>
              <li>Usage data, page views, and interaction analytics</li>
              <li>Referral sources and navigation paths</li>
              <li>Time zone settings and geographic location data</li>
              <li>Cookies and similar tracking technologies</li>
              <li>QR code scan data (when, where, and how codes are scanned)</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">
              2.3 QR Code Scan Analytics
            </h3>
            <p>When someone scans a QR code created through our service, we may collect:</p>
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>Date, time, and frequency of scans</li>
              <li>Geographic location data (city, country)</li>
              <li>Device type and operating system of the scanner</li>
              <li>Referral information and user agent data</li>
            </ul>
            <p className="mt-4">
              This data is aggregated and used to provide you with analytics about your QR code
              performance. Individual scanner identities are not tracked or stored.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>Provide, maintain, improve, and personalize our services</li>
              <li>Process your transactions and manage your account</li>
              <li>Generate, customize, and manage QR codes</li>
              <li>Provide analytics and insights about QR code performance</li>
              ...
              <li>Conduct research and development for service improvements</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li>
                <strong>Consent:</strong> You have given explicit consent for marketing
              ...
              <li>
                ...
                business interests, such as improving services and fraud prevention
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>
                <strong>Service Providers:</strong> With trusted third-party vendors who perform
                services on our behalf (hosting, analytics, payment processing, customer support),
                bound by confidentiality agreements
              </li>
              <li>
                <strong>Business Transfers:</strong> In connection with a merger, acquisition,
                reorganization, or sale of assets, with advance notice to users
              </li>
              <li>
                <strong>Legal Requirements:</strong> When required by law, court order, or
                government request, or to protect our rights, property, and safety
              </li>
              <li>
              ...
              <li>
                <strong>Aggregated Data:</strong> We may share anonymized, aggregated data that
          ...
          <section>
            ...
            <p>
              Your information may be transferred to and processed in countries outside of your
              country of residence, including countries that may not have the same data protection
              laws. When we transfer data internationally, we ensure appropriate safeguards are in
              place, including:
            </p>
            <ul className="list-disc pl-6 mt-4 space-y-2">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li>Secure socket layer (SSL/TLS) technology for data transmission</li>
          ...
          <section>
            ...
            <p>
              If you are a resident of the UK, European Economic Area (EEA), or other jurisdictions
              with data protection laws, you have the following rights:
            </p>
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>
                <strong>Right to Access:</strong> Request copies of your personal data and
              ...
              <li>
                <strong>Right to Erasure:</strong> Request deletion of your personal data under
              ...
              <li>
                <strong>Right to Data Portability:</strong> Request transfer of your data in a
              ...
              <li>
                ...
                rely on consent for processing
              </li>
              <li>
                <strong>Right to Lodge a Complaint:</strong> File a complaint with the ICO or your
                local data protection authority
              </li>
            </ul>
            <p className="mt-4">
              To exercise any of these rights, please contact us using the details below. We will
              respond to your request within one month, or inform you if we need additional time.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              <li>The type of data and purpose of processing</li>
              <li>Legal, regulatory, or contractual obligations</li>
              <li>Your account status (active or inactive)</li>
              <li>Business and operational needs</li>
            </ul>
            <p className="mt-4">
              When we no longer need your data, we will securely delete or anonymize it. You may
          ...
          <section>
            ...
            <p>
              ...
              parts of our Service may not function properly.
            </p>
            <p className="mt-4">
              For detailed information about our cookie usage, please see our separate Cookie
              Policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              With your consent, we may send you marketing emails about our products, services, and
              promotions. You can opt out of marketing communications at any time by:
            </p>
            <ul className="list-disc pl-6 mt-4 space-y-2">
            ...
            <p className="mt-4">
              Please note that even if you opt out of marketing communications, we will still send
              you essential service-related messages.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              Service after changes are posted constitutes acceptance of the updated Privacy Policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              practices, or if you wish to exercise your data protection rights, please contact us
              at:
            </p>
            <p className="mt-4">
              <strong>Email:</strong>{' '}
            ...
            <p className="mt-4">
              <strong>Supervisory Authority:</strong> If you are not satisfied with our response,
