...
export const metadata: Metadata = {
  title: 'Terms of Service - Karsaaz QR',
  description: 'Karsaaz QR Terms of Service and acceptable use policy.',
}
    ...
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-gray mt-8 max-w-none">
          ...
          <p>
            By accessing and using Karsaaz QR (&ldquo;Service&rdquo;), you agree to be bound by these
          ...
          <p>
            ...
            services. The Service includes a web-based dashboard, API access, and related tools
            for creating and managing QR codes.
          </p>
          ...
          <p>
            ...
            to pay the applicable fees. Subscription fees are billed in advance on a recurring
          ...
          <p>
            ...
            Karsaaz QR and are protected by international copyright, trademark, and other
            intellectual property laws. QR codes you generate remain your property.
          </p>
          ...
          <p>
            To the maximum extent permitted by law, Karsaaz QR shall not be liable for any
          ...
          <p>
            ...
            channels available in the Service dashboard.
          </p>
        </div>
      </div>
    </div>
