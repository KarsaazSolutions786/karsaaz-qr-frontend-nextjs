    ...
    <div className="flex min-h-[80vh] items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-xl border">
        ...
        <div className="rounded-lg bg-gray-50 p-4 border border-gray-100">
          <p className="text-sm text-gray-700"><strong>Organization Name:</strong> {orgName}</p>
          <p className="text-sm text-gray-700"><strong>Admin Email:</strong> {pendingRegData?.email || user?.email || 'N/A'}</p>
        </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            {form.formState.errors.organization_type && (
              <p className="mt-1 text-sm text-red-600">{form.formState.errors.organization_type.message}</p>
            )}
          </div>
