...
export default function PayingUsersPage() {
  ...
  const { data, isLoading } = useUsers({ page, search: search || undefined, paying: 'paying' as const })
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Paying Users</h1>
      ...
      <div className="mt-8">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">No paying users found</h3>
            <p className="mt-1 text-sm text-gray-500">
              No paying users match your search criteria.
            </p>
          </div>
        )}
      </div>
