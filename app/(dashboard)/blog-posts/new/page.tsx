  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">{t('Create Blog Post')}</h1>
          <p className="mt-2 text-sm text-gray-600">{t('Add a new blog post to your website')}</p>
        </div>
        <Link href="/blog-posts" className="text-sm text-blue-600 hover:text-blue-900">{t('← Back')}</Link>
      </div>
