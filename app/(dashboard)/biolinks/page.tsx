  ...
  if (isLoading) {
    return (
      <div className="flex h-64 items-center justify-center">
        <div className="text-gray-500">{t('Loading biolinks...')}</div>
      </div>
    )
  }
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">{t('Biolink Pages')}</h1>
          <p className="mt-2 text-sm text-gray-600">
            {t('Create custom landing pages with links and content blocks')}
          </p>
        </div>
