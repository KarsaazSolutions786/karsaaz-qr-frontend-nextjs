    ...
    return (
      <div className="flex min-h-[50vh] flex-col items-center justify-center text-center">
        <p className="mb-4 text-gray-600 dark:text-gray-400">
          {t('Please sign in to create QR codes.')}
        </p>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-8 text-center shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          {sessionLimits && (
            <p className="mt-4 text-xs text-gray-400">
              {t('QR Codes remaining')}: {sessionLimits.qrcodes.remaining}/
              {sessionLimits.qrcodes.max}
            </p>
          )}
        </div>
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mb-6">
        ...
        {sessionLimits && (
          <p className="mt-1 text-sm text-gray-500">
            {sessionLimits.qrcodes.remaining} {t('of')} {sessionLimits.qrcodes.max}{' '}
            {t('QR codes remaining')}
          </p>
        )}
      </div>
      ...
      {limitReached && (
        <div className="mb-6 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
          ...
          <p className="mt-1 text-sm text-amber-600 dark:text-amber-400">
            ...
            {t('to create more QR codes and unlock additional features.')}
          </p>
        </div>
      )}
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="flex gap-3">
          <Button variant="outline" onClick={handlePreview} disabled={isPreviewing || limitReached}>
            {isPreviewing ? <Loader size="sm" className="mr-2" /> : null}
            {t('Preview')}
          </Button>
          <Button onClick={handleCreate} disabled={isCreating || limitReached}>
