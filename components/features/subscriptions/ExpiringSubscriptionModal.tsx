      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            {t('Your subscription is expiring soon. Renew now to avoid any interruption to your services.')}
          </DialogDescription>
        </DialogHeader>
        ...
        <p className="text-center text-sm text-muted-foreground">
          {t('Renew your subscription to continue creating and managing QR codes, accessing analytics, and all premium features.')}
        </p>
