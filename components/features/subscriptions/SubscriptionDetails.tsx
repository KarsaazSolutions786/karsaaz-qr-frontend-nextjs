        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-gray-600">/{t('month')}</p>
            </div>
          </div>
          ...
          <dl className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <dt className="text-sm font-medium text-gray-500">{t('Next Billing Date')}</dt>
              <dd className="mt-1 text-sm text-gray-900">
                {subscription.cancelAtPeriodEnd
                  ? t('Subscription will not renew')
          ...
          {plan && (
            <div className="mt-6">
              <h3 className="text-sm font-medium text-gray-900">{t('Features')}</h3>
