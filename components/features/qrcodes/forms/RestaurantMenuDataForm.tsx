...
/**
 * Purpose: Executes RestaurantMenuDataForm functionality.
  ...
  return (
    <form className="space-y-5">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
          <label htmlFor="restaurant_name" className={LABEL}>{t('Restaurant Name')} *</label>
          <input {...register('restaurant_name')} id="restaurant_name" type="text" placeholder={t('My Restaurant')} className={INPUT} />
      ...
      <div>
        ...
        <input {...register('address')} id="address" type="text" placeholder={t('123 Main Street, City')} className={INPUT} />
      </div>
      <div>
        <label htmlFor="review_url" className={LABEL}>{t('Review URL')}</label>
      ...
      <div>
        <label htmlFor="maps_url" className={LABEL}>{t('Google Maps URL')}</label>
        <input {...register('maps_url')} id="maps_url" type="text" placeholder={t('Paste Google Maps share link')} className={INPUT} />
      </div>
      <div>
      ...
      <div>
        <label htmlFor="opening_hours_enabled" className={LABEL}>{t('Opening Hours')}</label>
