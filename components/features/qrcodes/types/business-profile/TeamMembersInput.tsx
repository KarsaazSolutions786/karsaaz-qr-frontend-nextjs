    ...
    <div className="space-y-4">
      ...
      {value.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed">
          ...
          <p className="text-gray-600 mb-4">{t('No team members added yet')}</p>
          <button
            type="button"
            onClick={addTeamMember}
            className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
          >
            {t('Add First Team Member')}
          </button>
        </div>
      ) : (
                    ...
                    <div className="flex items-start gap-3">
                          ...
                          <>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  placeholder={t('CEO, Designer, etc.')}
                                  className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                                />
                              </div>
                            </div>
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                placeholder={t('Short bio about this team member...')}
                                rows={3}
                                className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                              />
                            </div>
                      ...
                      <div className="flex flex-col gap-1">
                        <button
                          ...
                          title={member.featured ? t('Unfeature') : t('Feature')}
                        >
                          <Star
                            className={`w-4 h-4 ${
      ...
      <div className="text-xs text-gray-500 mt-2">
        {t('Tip: Click the star to feature key team members. Drag to reorder.')}
      </div>
    </div>
  );
}
