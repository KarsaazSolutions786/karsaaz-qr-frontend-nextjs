  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900">{t('Image Gallery')}</h3>
        <button
          type="button"
      ...
      {value.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed">
          ...
          <p className="text-gray-600 mb-4">{t('No images in gallery yet')}</p>
          <p className="text-sm text-gray-500 mb-4">
            {t('Upload images or add them from URLs')}
          </p>
          <button
            type="button"
            onClick={() => fileInputRef.current?.click()}
              ...
              return (
                ...
                >
                  <div className="aspect-square relative">
                    <img
                      src={image.url}
                      alt={image.alt || image.caption || t('Gallery image')}
                    ...
                    <div className="p-3 border-t bg-gray-50 space-y-2">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder={t('Alt text for accessibility...')}
                          className="w-full px-2 py-1.5 text-sm border rounded focus:ring-2 focus:ring-blue-500"
                        />
                      </div>
                      <button
      ...
      <div className="text-xs text-gray-500 mt-2">
        {t('Tip: Drag images to reorder them. Click edit to add captions.')}
      </div>
    </div>
  );
}
