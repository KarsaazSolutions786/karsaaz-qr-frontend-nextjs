  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="max-w-md rounded-lg bg-white p-6 shadow-xl">
        ...
        <h3 className="text-center text-lg font-semibold text-gray-900">{t('Delete QR Code?')}</h3>

        <p className="mt-3 text-center text-sm text-gray-600">
          {t('Are you sure you want to delete')} <strong>&quot;{qrcode.name}&quot;</strong>?
        </p>

        <p className="mt-2 text-center text-sm text-gray-500">
          {t('This action cannot be undone. All scan statistics will be lost.')}
        </p>
