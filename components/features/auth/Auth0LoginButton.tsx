...
export function Auth0LoginButton() {
  ...
  const apiBase = typeof window !== 'undefined' ? envConfig.API_URL : ''
  ...
  return (
    ...
    >
      <svg className="h-5 w-5" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M55.6 40.3L50.5 24.5 32 0 13.5 24.5 8.4 40.3l23.6-9.3 23.6 9.3z" fill="#EB5424" />
        <path
          d="M8.4 40.3l5.1 15.8L32 46.8l-23.6-6.5zM55.6 40.3l-5.1 15.8L32 46.8l23.6-6.5z"
          fill="#EB5424"
        />
        <path d="M13.5 56.1L32 64l18.5-7.9L32 46.8 13.5 56.1z" fill="#EB5424" />
      </svg>
